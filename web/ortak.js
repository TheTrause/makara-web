...
(function () {
  ...
  var S = {
    ...
    g_sifre_bag: ['Şifreni mi unuttun?', 'Forgot your password?'],
    s_baslik: ['Şifreni sıfırla', 'Reset your password'],
    s_alt1: ['Hesabının e-posta adresini yaz; sana 6 haneli bir kod gönderelim.',
      'Enter your account email and we will send you a 6-digit code.'],
    s_alt2: ['{0} adresine kayıtlı bir hesap varsa 6 haneli kod gönderdik. Kodu ve yeni şifreni gir.',
      'If an account exists for {0}, we sent a 6-digit code. Enter it with your new password.'],
    s_kod_gonder: ['Kod gönder', 'Send code'],
    s_girise: ['Girişe dön', 'Back to sign in'],
    s_kod: ['6 haneli kod', '6-digit code'],
    s_yeni: ['Yeni şifre', 'New password'],
    s_yeni2: ['Yeni şifre (tekrar)', 'New password (again)'],
    s_kaydet: ['Şifreyi değiştir', 'Change password'],
    s_yeniden: ['Kodu yeniden gönder', 'Resend code'],
    s_yeniden_gitti: ['Yeni bir kod gönderdik.', 'We sent a new code.'],
    s_eposta_gir: ['Geçerli bir e-posta adresi gir.', 'Enter a valid email address.'],
    s_kod_bicim: ['E-postadaki kodu rakamlarıyla gir.', 'Enter the code from the email (digits only).'],
    s_kod_hatali: ['Kod hatalı ya da süresi dolmuş. Yeni kod isteyebilirsin.',
      'The code is wrong or has expired. You can request a new one.'],
    s_zayif: ['Şifre en az 6 karakter olmalı.', 'The password must be at least 6 characters.'],
    s_ayni: ['Yeni şifre eskisiyle aynı olamaz.', 'The new password cannot be the same as the old one.'],
    s_eslesmiyor: ['İki şifre aynı değil.', 'The two passwords do not match.'],
